...
class _NotificationSettingsPageState extends State<NotificationSettingsPage> {
  bool generalEnabled = true;
  bool eventsEnabled = true;
  bool offersEnabled = true;

  void toggleSubscription(String topic, bool subscribe) async {
    if (subscribe) {
        ...
        children: [
          SwitchListTile(
            ...
            onChanged: (value) {
              ...
              toggleSubscription("general_channel", value);
            },
          ),
          SwitchListTile(
            ...
            onChanged: (value) {
              eventsEnabled = value;
              toggleSubscription("events_channel", value);
            },
          ),
          SwitchListTile(
            ...
            onChanged: (value) {
              offersEnabled = value;
              toggleSubscription("offers_channel", value);
            },
          ),
        ],
      ),
